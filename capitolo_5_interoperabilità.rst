...
l’implementazione delle API, aggiornando il Sistema Pubblico di
Cooperazione Applicativa (in breve SPCoop) emanato nel 2005.
...
Catalogo), la componente unica e centralizzata realizzata per favorire
la ricerca e l’utilizzo delle API. Una PA può delegare la gestione delle
API all’interno del Catalogo ad un’altra Amministrazione, denominata
Ente Capofila, relativamente a specifici contesti territoriali e/o
ambiti tematici.
...
.. toctree::
  ...
  capitolo-5-interoperabilità/obiettivi-e-risultati-attesi-4.rst
